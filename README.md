...
## Features
- **Feature 1: Validate user input and either prevent the invalid input or inform the user about it (in all cases prevent invalid input from being stored or saved):** Description for how I am using the feature here.
- **Feature 2: Persist important data to the user to local storage and make the stored data accessible in your app. (including after reload/refresh):** Description for how I am using the feature here.
- **Feature 3: Analyze data that is stored in arrays, objects, sets or maps and display information about it in your app:** Description for how I am using the feature here.
